...
//
// In your "lib/chat_socket_server_web/router.ex":
//
//     pipeline :browser do
//       ...
//       plug MyAuth
...
// inside a script tag in "lib/chat_socket_server_web/templates/layout/app.html.heex":
//
//     <script>window.userToken = "<%= assigns[:user_token] %>";</script>
//
// You will need to verify the user token in the "connect/3" function
// in "lib/chat_socket_server_web/channels/user_socket.ex":
//
...
/* let room_channel = socket.channel("room:42", {})
room_channel.join()
...
class NetClient {
    ...
    public connect(token: string) {
        this._socket.connect({ token: token });
        this.connected = true;
    }
